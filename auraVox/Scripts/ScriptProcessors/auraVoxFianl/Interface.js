...
const var WebsiteButton7 = Content.getComponent("WebsiteButton7");
...
inline function OpenLink(c, v)
{
    ...
    else if (c == WebsiteButton7)
            Engine.openWebsite("https://www.quietformat.com/auravox");    
}
...
if (WebsiteButton7) WebsiteButton7.setControlCallback(OpenLink);
...
{
    // ★ 여기서 3분, 2회
    const var DURATION_MS  = 20 * 60 * 1000;
